...
export const getContentSideBar = (contentType) => {
  ...
  <li class="task-item active ${classes}" data-role="show-task" data-name="recent"><i class="fa-solid fa-clock"></i><span>Recent</span><span class="ml-auto">
    ${isContentTasks ? allTaskList.length : ""}</span></li>
  ${
    isContentTasks
      ...
      : `<li class="task-item ${classes}" data-role="show-task" data-name="all-notes"><i class="fa-solid fa-circle-check"></i><span>All notes</span><span class="ml-auto"></span></li>`
  }
  ...
  <li class="task-item folder mt-10 overflow-hidden flex items-center flex-col gap-3  sm:text-base text-xs" data-name="folder">
    <div class="hover:bg-white cursor-default flex items-center gap-2 py-2 px-4 w-full rounded-full ">
      <i class="fa-solid fa-angle-down"></i><span>Folders</span><span class="ml-auto">${
        allFolders.length
      }</span>
    </div>
  </li>
  <li class="task-item tags cursor-default flex flex-col gap-3 items-center overflow-hidden  sm:text-base text-xs" data-name="tags">
    <div class="hover:bg-white cursor-default flex items-center gap-2 py-2 px-4 w-full rounded-full">
    <i class="fa-solid fa-angle-down"></i><span>Tags</span><span class="ml-auto">${
      allTags.length
    }</span>
    </div>
  </li>
